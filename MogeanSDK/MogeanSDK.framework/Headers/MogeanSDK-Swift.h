...
+ (Mogean * __nonnull)sharedInstance;
@property (nonatomic, strong) id <MogeanDelegate> __nullable mogeandelegate;
@property (nonatomic, copy) NSString * __nullable peelID;
@property (nonatomic, copy) NSString * __nullable mogeanConsumerKey;
@property (nonatomic, copy) NSString * __nullable mogeanConsumerSecret;
- (NSString * __nullable)getAdvertisingIdentifier;
- (NSArray * __nonnull)getKnownBeacons;
...
- (void)setCustomEvent:(NSString * __nonnull)eventType;
@end


SWIFT_PROTOCOL("_TtP9MogeanSDK14MogeanDelegate_")
@protocol MogeanDelegate
- (void)didUpdateLocation:(CLLocation * __nonnull)location;
@optional
- (void)debugMessage:(NSString * __nonnull)message;
@end
