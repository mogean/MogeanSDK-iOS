...
SWIFT_CLASS("_TtC9MogeanSDK6Mogean")
@interface Mogean : NSObject <CLLocationManagerDelegate>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Mogean * _Nonnull sharedInstance;)
+ (Mogean * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, strong) id <MogeanDelegate> _Nullable mogeandelegate;
...
- (NSString * _Nonnull)getStackCounts SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nullable)getAdvertisingIdentifier SWIFT_WARN_UNUSED_RESULT;
- (NSArray * _Nonnull)getKnownBeacons SWIFT_WARN_UNUSED_RESULT;
...
- (NSString * _Nonnull)getDate SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)calculateDwellTime:(NSString * _Nonnull)enterTime SWIFT_WARN_UNUSED_RESULT;
@end
