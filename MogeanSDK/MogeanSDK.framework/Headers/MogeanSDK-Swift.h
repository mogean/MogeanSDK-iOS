...
+ (Mogean * _Nonnull)sharedInstance;
...
- (void)geoLocateUserUsingDataElements;
...
- (void)dataElementsLocationUpdateWithElements:(NSDictionary<NSString *, NSString *> * _Nonnull)elements;
@end
